...
nF_vec = 1:1:10; % Number of fake eavesdroppers
...
for nF_idx=1:length(nF_vec)
    ...
    for ao = 1:max_AO_iter
       ...
       Convex_Convergence_curve_AO(ao,nF_idx) = -prev_cost;
        Convex_Fake_Convergence_curve_AO(ao,nF_idx) = best_fake_secrecy;
        Convex_Real_Convergence_curve_AO(ao,nF_idx) = best_real_secrecy;
...
plot(PSO_Convergence_curve(end,1:end), 'Color', colors(1,:), 'LineStyle','-.', 'LineWidth',2, 'Marker','v', 'MarkerIndices',1:markerInterval:length(PSO_Convergence_curve), 'MarkerFaceColor',colors(1,:))
plot(Convex_Convergence_curve_AO(end,1:end), 'Color', colors(3,:), 'LineStyle','-.', 'LineWidth',2, 'Marker','o', 'MarkerIndices',1:markerInterval:length(Convex_Convergence_curve_AO), 'MarkerFaceColor',colors(3,:))
plot(HSCA_Convergence_curve_AO(end,1:end), 'Color', colors(4,:), 'LineStyle','--', 'LineWidth',1.8, 'Marker','^', 'MarkerIndices',1:markerInterval:length(HSCA_Convergence_curve_AO(end,1:end)), 'MarkerFaceColor',colors(4,:))
...
% Convex + Manopt
plot(Convex_Fake_Convergence_curve_AO(end,1:end), 'Color', colors(3,:), 'LineStyle','--', 'LineWidth',1.5, 'Marker','s', 'MarkerIndices',1:markerInterval:length(Convex_Fake_Convergence_curve_AO(end,1:end)), 'MarkerFaceColor',colors(3,:));
plot(Convex_Real_Convergence_curve_AO(end,1:end), 'Color', colors(3,:), 'LineStyle',':', 'LineWidth',1.5, 'Marker','^', 'MarkerIndices',1:markerInterval:length(Convex_Real_Convergence_curve_AO(end,1:end)), 'MarkerFaceColor',colors(3,:));
