...
fprintf('\nConvex AO Finished! Best Fake Secrecy Rate = %.8f\n', best_fake_secrecy);
 ...
 Convex_Real_Convergence_curve_AO(mc_iter,N_idx) = best_real_secrecy;
...
% Original data
NResults.Convex_min_Rk = Convex_min_Rk;
NResults.Convex_Convergence_curve_AO = Convex_Convergence_curve_AO;
NResults.Convex_Fake_Convergence_curve_AO = Convex_Fake_Convergence_curve_AO;
NResults.Convex_Real_Convergence_curve_AO = Convex_Real_Convergence_curve_AO;
NResults.feasible_record = feasible_record;

% Processed data
NResults.valid_records_Qtd = valid_records_Qtd;
NResults.Convex_min_Rk_mean = Convex_min_Rk_mean;
NResults.Convex_Convergence_curve_AO_mean = Convex_Convergence_curve_AO_mean;
NResults.Convex_Fake_Convergence_curve_AO_mean = Convex_Fake_Convergence_curve_AO_mean;
