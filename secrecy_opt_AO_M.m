...
%fprintf('\nConvex AO Finished! Best Fake Secrecy Rate = %.8f\n', best_fake_secrecy);
 ...
 Convex_Fake_Convergence_curve_AO(mc_iter,M_idx) = best_fake_secrecy;
 Convex_Real_Convergence_curve_AO(mc_iter,M_idx) = best_real_secrecy;
...
hold on;
plot(M_vec,Convex_Convergence_curve_AO_mean(1:end), 'Color', colors(3,:), 'LineStyle','-.', 'LineWidth',2, 'Marker','o', 'MarkerIndices',1:markerInterval:length(Convex_Convergence_curve_AO_mean), 'MarkerFaceColor',colors(3,:))


%title('Convergence Curve','FontWeight','bold','FontSize',12);
xlabel('M','FontWeight','bold','FontSize',11);
...
% Convex + Manopt
plot(M_vec,Convex_min_Rk_mean(1:end), 'Color', colors(1,:), 'LineStyle','--', 'LineWidth',1.5, 'Marker','s', 'MarkerIndices',1:markerInterval:length(Convex_Fake_Convergence_curve_AO(1:end)), 'MarkerFaceColor',colors(1,:));
plot(M_vec,Convex_Fake_Convergence_curve_AO_mean(1:end), 'Color', colors(3,:), 'LineStyle','--', 'LineWidth',1.5, 'Marker','s', 'MarkerIndices',1:markerInterval:length(Convex_Fake_Convergence_curve_AO(1:end)), 'MarkerFaceColor',colors(3,:));
plot(M_vec,Convex_Real_Convergence_curve_AO_mean(1:end), 'Color', colors(3,:), 'LineStyle','-', 'LineWidth',1.5, 'Marker','s', 'MarkerIndices',1:markerInterval:length(Convex_Real_Convergence_curve_AO(1:end)), 'MarkerFaceColor',colors(3,:));
...
% Original data
MResults.Convex_min_Rk = Convex_min_Rk;
MResults.Convex_Convergence_curve_AO = Convex_Convergence_curve_AO;
MResults.Convex_Fake_Convergence_curve_AO = Convex_Fake_Convergence_curve_AO;
MResults.Convex_Real_Convergence_curve_AO = Convex_Real_Convergence_curve_AO;
MResults.feasible_record = feasible_record;

% Processed data
MResults.valid_records_Qtd = valid_records_Qtd;
MResults.Convex_min_Rk_mean = Convex_min_Rk_mean;
MResults.Convex_Convergence_curve_AO_mean = Convex_Convergence_curve_AO_mean;
MResults.Convex_Fake_Convergence_curve_AO_mean = Convex_Fake_Convergence_curve_AO_mean;
MResults.Convex_Real_Convergence_curve_AO_mean = Convex_Real_Convergence_curve_AO_mean;

% Save
save('MResults.mat', 'MResults', '-v7.3');