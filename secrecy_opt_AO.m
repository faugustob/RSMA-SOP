...
Ns = 600; % number of samples for Monte Carlo simulation
%rng(2);
...
PSO_Real_secrecy_rate_curve_mean = mean(PSO_Real_secrecy_rate_curve,1);

HSCA_Convergence_curve_AO_mean = mean(HSCA_Convergence_curve_AO,1);
