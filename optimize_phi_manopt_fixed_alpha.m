function [phi_St,cost_opt] = optimize_phi_manopt_fixed_alpha(Rmin,L_node,E_node,problem,b0,alpha,K, nF, sigma2, Pw, AN_P_ratio)
        ...
        s_param = 30; % Smoothing parameter for max-min
        lambda_penalty = 1e3;
       ...
       % fprintf('Starting Manifold Optimization...\n');
        ...
        options.tolgradnorm = 1e-5;    % Stop when the gradient norm is very small
        options.maxiter = 1e3;         % Maximum outer iterations
